...
namespace RepositoryManager.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly RepositoryManagerDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = RepositoryManagerConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(RepositoryManagerDbContext context)
        {
            _context = context;
        }
