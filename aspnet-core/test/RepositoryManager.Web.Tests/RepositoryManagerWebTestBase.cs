...
{
    public abstract class RepositoryManagerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RepositoryManagerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RepositoryManagerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RepositoryManagerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RepositoryManagerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RepositoryManagerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RepositoryManagerDbContext, Task<T>> func)
        {
            T result;
